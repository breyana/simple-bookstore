...
COPY authors(id, first_name, last_name) FROM '/Users/breyana/Documents/Code/simple-bookstore/seeds/authors.csv' DELIMITERS ',' CSV;
COPY genres(id, name) FROM '/Users/breyana/Documents/Code/simple-bookstore/seeds/genres.csv' DELIMITERS ',' CSV;
